          ...
          <FlatList
            ...
            renderItem={({item}) => {
              return (
                <Card>
                  <View style={{}}>
                  <View style={[styles.flexRowWithGap,{justifyContent:'space-between'}]}>
                    <Text style={styles.room_num}>Arti</Text>
                    <Text style={[styles.room_num,{color:colors.AppDefaultColor}]}>004</Text>
                  </View>
                    <View>
                    ...
                    <View
                      ...
                      <TouchableOpacity style={[styles.btn,{backgroundColor:colors.AppDefaultColor}]}>
                        <Text
                          style={{
                            fontSize: 16,
                            color: colors.white,
                      ...
                      <TouchableOpacity
                        ...
                        <Text
                          ...
                          Response <Icon name={'share'} color={colors.white} size={20} />
                        </Text>
                      </TouchableOpacity>
                    </View>
                  </View>
